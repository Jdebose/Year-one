...
public enum DiskColor {
	...
	public static DiskColor random() {//randomizes disk color
		Random rand = new Random();
		int i = rand.nextInt(DiskColor.values().length);// TODO Auto-generated method stub
		return DiskColor.values()[i];
	}
}
